...
class SerialSocket extends BluetoothGattCallback {
    ...
    private static final UUID MEGAPI_1 = UUID.fromString("0000ffe1-0000-1000-8000-00805f9b34fb");
    private static final UUID MEGAPI_2 = UUID.fromString("0000ffe2-0000-1000-8000-00805f9b34fb");
    private static final UUID MEGAPI_3 = UUID.fromString("0000ffe3-0000-1000-8000-00805f9b34fb");
    ...
    public void onServicesDiscovered(BluetoothGatt gatt, int status) {
        ...
        for (BluetoothGattService gattService : gatt.getServices()) {
            if (gattService.getUuid().equals(MEGAPI_1)) {
                Log.d(TAG, "service nrf uart");
                //for(BluetoothGattCharacteristic characteristic : gattService.getCharacteristics())
                //    Log.d(TAG, "characteristic "+characteristic.getUuid());
                BluetoothGattCharacteristic rw2 = gattService.getCharacteristic(MEGAPI_2);
                BluetoothGattCharacteristic rw3 = gattService.getCharacteristic(MEGAPI_3);
